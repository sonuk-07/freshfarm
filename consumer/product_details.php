        ...
        <nav aria-label="breadcrumb" class="mb-4">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a
                        href="products.php?category=<?php echo $product['category_id']; ?>"><?php echo htmlspecialchars($product['category_name'] ?? 'Uncategorized'); ?></a>
                </li>
        ...
        <div class="row">
            ...
            <div class="col-md-5 mb-4">
                <?php if (!empty($product['product_image'])): ?>
                    <img src="../uploads/products/<?php echo $product['product_image']; ?>" class="img-fluid product-img"
            ...
            <div class="col-md-7 mb-4">
                <div class="d-flex justify-content-between align-items-start mb-2">
                    <span
                        class="category-badge"><?php echo htmlspecialchars($product['category_name'] ?? 'Uncategorized'); ?></span>
                ...
                <div class="mb-4">
                    ...
                    <p class="mb-1"><strong>Added on:</strong>
                        <?php echo date('F j, Y', strtotime($product['created_at'])); ?></p>
                </div>
                        ...
                        <div class="d-flex align-items-center">
                            <div class="farmer-avatar me-3">
                                <?php if (!empty($product['profile_image'])): ?>
                                    <img src="../uploads/profiles/<?php echo $product['profile_image']; ?>" alt="Farmer"
                        ...
                        <div class="col">
                            <div class="card product-card h-100">
                                <?php if (!empty($related['product_image'])): ?>
                                    <img src="../uploads/products/<?php echo $related['product_image']; ?>"
                                        class="card-img-top related-img" alt="<?php echo htmlspecialchars($related['name']); ?>">
                                <?php else: ?>
                                    <img src="../assets/images/product-placeholder.jpg" class="card-img-top related-img"
                                        alt="Product Image">
                                <?php endif; ?>
                                ...
                                <div class="card-body d-flex flex-column">
                                    ...
                                    <p class="card-text text-primary fw-bold mb-2">
                                        $<?php echo number_format($related['price'], 2); ?></p>
